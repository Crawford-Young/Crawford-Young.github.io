...
export default function ExperiencePage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <section>
        <p className="text-[10px] font-semibold text-accent uppercase tracking-[0.15em] mb-8">Work</p>
      ...
      <section>
        <p className="text-[10px] font-semibold text-accent uppercase tracking-[0.15em] mb-8">Education</p>
